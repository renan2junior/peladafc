...
class Pelada(db.Model):
    ...
    local_pelada = db.Column(db.String(256), unique=False)
    ...
    def __init__(self, nome_contato, email_contato, local_pelada, nome_pelada, horario_pelada, telefone_pelada, conta_pelada, user_id):
